                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="card card-custom gutter-b example example-compact">
                                                ...
                                                <!--begin::Form-->
                                                <form class="form" id="edit_person_form"  enctype="multipart/form-data" >
                                                    <input type="hidden" name="id" id="personID" value="{{ $id }}" />
                                                    @csrf
                                                    <div class="card-body">
                                                        <div class="mb-15">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" name="email" id="email" class="form-control" placeholder="Enter Person Email" value="{{ $person->email }}" />
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <input type="text" name="phone" id="phone" class="form-control" placeholder="Enter Person Phone" value="{{ $person->phone }}" />
                                                                    <span class="form-text text-muted">Please enter person phone</span>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="image-input image-input-outline" id="kt_image_1">
                                                                        <div class="image-input-wrapper" style="background-image: url({{ $person->avatar ? asset('storage/' . $person->avatar) : '../assets/img/blank.png' }})"></div>
                                                                ...
                                                                <div class="col-lg-4 col-md-9 col-sm-12">
                                                                    <select class="form-control" id="kt_select2_1" name="organization">
                                                                        @foreach($organizations as $organization)
                                                                            <option value="{{ $organization->id }}" {{ $person->organization_id == $organization->id ? 'selected' : '' }}>{{ $organization->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card-footer">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                ...
                                                                <button type="button" id="btn_delete_person" class="btn btn-danger mr-2">Delete</button>
